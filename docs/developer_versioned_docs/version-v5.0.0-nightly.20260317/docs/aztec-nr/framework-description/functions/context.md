...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/noir-projects/aztec-nr/aztec/src/context/private_context.nr#L140-L163" target="_blank" rel="noopener noreferrer">Source code: noir-projects/aztec-nr/aztec/src/context/private_context.nr#L140-L163</a></sub></sup>
...
pub struct CallContext {
    // The address of the contract that is making the call.
    pub msg_sender: AztecAddress,
    // The address of the contract being called.
    pub contract_address: AztecAddress,
    // The selector of the function being called.
    pub function_selector: FunctionSelector,
    // Whether the call will modify the state of the contract.
    pub is_static_call: bool,
}
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/noir-projects/noir-protocol-circuits/crates/types/src/abis/call_context.nr#L8-L20" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-protocol-circuits/crates/types/src/abis/call_context.nr#L8-L20</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/noir-projects/noir-protocol-circuits/crates/types/src/abis/block_header.nr#L12-L29" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-protocol-circuits/crates/types/src/abis/block_header.nr#L12-L29</a></sub></sup>
...
```rust title="expiration-timestamp" showLineNumbers 
pub fn set_expiration_timestamp(&mut self, expiration_timestamp: u64) {
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/noir-projects/aztec-nr/aztec/src/context/private_context.nr#L599-L601" target="_blank" rel="noopener noreferrer">Source code: noir-projects/aztec-nr/aztec/src/context/private_context.nr#L599-L601</a></sub></sup>

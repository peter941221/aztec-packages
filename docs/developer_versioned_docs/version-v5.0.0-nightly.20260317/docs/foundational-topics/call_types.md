...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/noir-projects/noir-contracts/contracts/app/lending_contract/src/main.nr#L255-L257" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/lending_contract/src/main.nr#L255-L257</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/noir-projects/noir-contracts/contracts/app/lending_contract/src/main.nr#L125-L127" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/lending_contract/src/main.nr#L125-L127</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/noir-projects/noir-contracts/contracts/protocol/public_checks_contract/src/utils.nr#L19-L23" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/protocol/public_checks_contract/src/utils.nr#L19-L23</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/noir-projects/noir-contracts/contracts/app/crowdfunding_contract/src/main.nr#L48-L50" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/app/crowdfunding_contract/src/main.nr#L48-L50</a></sub></sup>
...
```rust title="helper_public_checks_functions" showLineNumbers 
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/noir-projects/noir-contracts/contracts/protocol/public_checks_contract/src/utils.nr#L5-L25" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/protocol/public_checks_contract/src/utils.nr#L5-L25</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/noir-projects/noir-contracts/contracts/protocol/public_checks_contract/src/main.nr#L15-L25" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/protocol/public_checks_contract/src/main.nr#L15-L25</a></sub></sup>
...
```toml
[dependencies]
public_checks = { git = "https://github.com/AztecProtocol/aztec-packages/", tag = "v5.0.0-nightly.20260317", directory = "noir-projects/noir-contracts/contracts/protocol/public_checks_contract" }
```
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/noir-projects/noir-contracts/contracts/fees/fpc_contract/src/main.nr#L169-L176" target="_blank" rel="noopener noreferrer">Source code: noir-projects/noir-contracts/contracts/fees/fpc_contract/src/main.nr#L169-L176</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/docs/examples/ts/aztecjs_connection/index.ts#L135-L141" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_connection/index.ts#L135-L141</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/yarn-project/end-to-end/src/e2e_card_game.test.ts#L113-L115" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_card_game.test.ts#L113-L115</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v5.0.0-nightly.20260317/yarn-project/end-to-end/src/e2e_crowdfunding_and_claim.test.ts#L208-L212" target="_blank" rel="noopener noreferrer">Source code: yarn-project/end-to-end/src/e2e_crowdfunding_and_claim.test.ts#L208-L212</a></sub></sup>

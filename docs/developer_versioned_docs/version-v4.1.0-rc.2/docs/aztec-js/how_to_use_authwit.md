...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.1.0-rc.2/docs/examples/ts/aztecjs_authwit/index.ts#L43-L63" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_authwit/index.ts#L43-L63</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.1.0-rc.2/docs/examples/ts/aztecjs_authwit/index.ts#L65-L88" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_authwit/index.ts#L65-L88</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.1.0-rc.2/docs/examples/ts/aztecjs_authwit/index.ts#L90-L108" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_authwit/index.ts#L90-L108</a></sub></sup>
...
```
> <sup><sub><a href="https://github.com/AztecProtocol/aztec-packages/blob/v4.1.0-rc.2/docs/examples/ts/aztecjs_authwit/index.ts#L110-L137" target="_blank" rel="noopener noreferrer">Source code: docs/examples/ts/aztecjs_authwit/index.ts#L110-L137</a></sub></sup>

...
SEQ_LAST_BLOCK_DURATION_MS=${SEQ_LAST_BLOCK_DURATION_MS:-}
...
# Total publishers = replicas * publishers_per_replica * (1 + HA_REPLICAS)
...
SEQ_LAST_BLOCK_DURATION_MS = ${SEQ_LAST_BLOCK_DURATION_MS:-null}
